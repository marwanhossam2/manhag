  ...
  return (
    <div className="max-w-4xl">
      ...
      <div className="flex space-x-1 bg-gray-100 p-1 rounded-xl mb-8">
        {[
          { id: "profile", label: "Profile", color: "indigo" },
          { id: "security", label: "Security", color: "emerald" },
          { id: "payout", label: "Payout", color: "green" },
        ].map((tab) => (
          <button
            key={tab.id}
      ...
      {activeTab === "profile" && (
        <div className="bg-white rounded-2xl shadow-sm border p-6 space-y-6">
          ...
          <div className="border-t pt-6">
            ...
            <button className="mt-6 px-6 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-medium rounded-lg hover:from-indigo-600 hover:to-purple-700 transition-all">
              Save Changes
            </button>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-2xl shadow-sm border p-6">
            ...
            <div className="space-y-4 max-w-md">
              ...
              <button className="px-6 py-2 bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-medium rounded-lg hover:from-emerald-600 hover:to-teal-700 transition-all">
                Update Password
              </button>
            </div>
          </div>
      ...
      {activeTab === "payout" && (
        <div className="bg-white rounded-2xl shadow-sm border p-6">
          ...
          <p className="text-gray-600 mb-6">Configure how you receive your earnings</p>
